...
func EnglishStrings() AgentStrings {
	return AgentStrings{
		...
		ToolCallInstructions:  "To use a tool, respond with: <tool_call name=\"tool_name\">{\"path\": \"/path/to/file\", \"max\": 100, \"start\": 1}</tool_call>\n",
...
func ChineseStrings() AgentStrings {
	return AgentStrings{
		...
		ToolCallInstructions:  "要使用工具，请回复：<tool_call name=\"tool_name\">{\"path\": \"/path/to/file\", \"max\": 100, \"start\": 1}</tool_call>\n",
